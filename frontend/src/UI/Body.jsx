...
//     <div className="min-h-screen relative flex lg:flex-row">
//       {/* Left panel - grows to fill available space, maintains minimum height on mobile */}
//       <div className="flex-1 min-h-[500px] lg:h-auto bg-base-200 p-4 flex flex-col">
...
//       <div className="flex-1 min-h-[500px] lg:h-auto bg-base-300 p-4 flex flex-col">
...
export default function Body() {
  ...
  return (
    ...
    <div className="min-h-screen relative flex flex-col lg:flex-row">
      ...
      <div className="w-full lg:w-1/2 lg:flex-1 min-h-[auto] bg-base-200 p-4 flex flex-col">
        <span className="text-center text-xl font-montserrat mb-6">
          Discover
        </span>
      ...
      <div className="w-full lg:w-1/2 md:flex-1 lg:flex-1 min-h-[auto] bg-base-300 p-4 flex flex-col">
        {/* Header with centered text */}
        <span className="text-center text-xl font-montserrat mb-6">
          Movies for you
        </span>
